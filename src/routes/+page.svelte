...
<div class="card bg-white">
	<div class="card-body flex flex-row justify-evenly py-4">
		<img class="h-auto w-24" src="images/no_to_racism.jpg" alt="No to Racism" />
		<img class="h-auto w-24" src="images/black_lives_matter.jpg" alt="Black Lives Matter" />
	</div>
</div>
